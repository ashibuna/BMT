...
mySerial.begin(9600); //check if this baud rate is updated or not..

 Wire.begin();
  Wire.setClock(400000L);

   
     setupMPU();//calibrating gyroscope is not here as it is not  really supposed to be here.
      timer = micros();
}
